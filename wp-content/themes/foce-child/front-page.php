...
?>
    ...
    <main id="primary" class="site-main">
        ...
        <section id="story" class="story animation">            
            <h2>L'histoire</h2>
            ...
            <article id="place">
                <div>
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/little_cloud.png'; ?> " alt="image petit nuage">
                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/big_cloud.png'; ?> " alt="image grand nuage">
                </div>
            </article>
        </section>
